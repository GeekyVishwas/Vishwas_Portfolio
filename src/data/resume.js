...
export const timeline = [
  ...
  {
    year: '2024',
    title: 'Joined BDO India as Associate Consultant',
    org: 'BDO India Service Pvt. Ltd.',
    description: 'Began professional career working on enterprise-grade data pipelines, AI agents, and cloud analytics.',
    icon: '💼',
